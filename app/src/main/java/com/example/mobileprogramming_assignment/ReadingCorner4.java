...
public class ReadingCorner4 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id_done_Button.setOnClickListener(v -> {
            ...
            myTextView.setText("How to deal with Troubling behaviour Person?");
            ...
            RadioButton1.setText("Be calm but bad attitude");
            RadioButton2.setText("Keeping a negative and unfriendly tone");
            RadioButton3.setText("Ask a GP for an assessment");
            ...
            closeButton.setOnClickListener(task -> {
                ...
                Toast.makeText(this, "Topic 4: Dealing with Trouble Behavior Person - Completed", Toast.LENGTH_SHORT).show();
                popupWindow.dismiss();
            });
        });
    }
    ...
    public void navLogout(){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(ReadingCorner4.this, SignInActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                overridePendingTransition(R.anim.from_right_in, R.anim.from_left_out);
            }
